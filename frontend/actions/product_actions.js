...
export const fetchProducts = (filters) => (dispatch) => {
  return ProductAPIUtil.fetchProducts(filters).then((products) =>
...
export const createProduct = (formData) => (dispatch) => {
  return ProductAPIUtil.createProduct(formData).then(
...
export const updateProduct = (formData) => (dispatch) => {
  return ProductAPIUtil.updateProduct(formData).then(
    (product) => dispatch(receiveProduct(product)),
    (errs) => dispatch(receiveErrors(errs.responseJSON))
  );
};
...
export const removeProduct = (productId) => (dispatch) => {
  return ProductAPIUtil.removeProduct(productId).then(
